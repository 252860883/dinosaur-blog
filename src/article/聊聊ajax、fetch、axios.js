...
<p>1.拦截请求和响应<br></br>2.转换请求和响应数据<br></br>3.支持 Promise API<br></br>4.提供了一些并发操作的方法<br></br>5.自动转换JSON数据<br></br>6.客户端支持防范XSRF<br></br>7.支持取消请求<br></br>8.从node.js发出http请求</p>
