...
<div className="title">【项目总结】大牛工资条</div>
<h2>v1.0上线版 2017/10/13-2017/11/2</h2>

<h2>1.默认电话号码字段点击会触发系统拨号</h2>
...
<h2>2.safari浏览器移动端兼容问题</h2>

<h4>safari浏览器对于input标签设定有默认的事件</h4>
...
<h4>safari 默认点击 a，button，input时会有一层灰色的遮罩</h4>
...
<h2>5.移动端ios下触发input再点击其他区域无法失去焦点</h2>
...
<h2>10.工资表详情页面双击跳到放大页面再返回不强制刷新</h2>
...
<h2>11.路由跳转时设置过渡效果，以及过渡时间的设置</h2>
...
<h2>12.路由绑定query的值时只能接受基本数据类型 Number、String、Boolean等</h2>

<p>因为过去时要传递一个对象Object格式的，所以造成了传递过去的内容只是[object]，所以在传递的时候需要进行字符串的转化 JSON.stringfy（...）</p>

<h2>13.input在IE下回车会默认执行提交事件</h2>
